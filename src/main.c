...
void volume_down(const struct device *dev, struct gpio_callback *cb, uint32_t pins)
{
	LOG_INF("Volume down!");
}
void volume_up(const struct device *dev, struct gpio_callback *cb, uint32_t pins)
{
	LOG_INF("Volume up!");
}
